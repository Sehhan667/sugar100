...
execute if score #toggle maxlefttimeset matches 1 run tellraw @a {text:"left安装时间已设为1分钟！",color:"green"}
execute if score #toggle maxlefttimeset matches 2 run tellraw @a {text:"left安装时间已设为2分钟！",color:"green"}
execute if score #toggle maxlefttimeset matches 3 run tellraw @a {text:"left安装时间已设为3分钟！",color:"green"}
execute if score #toggle maxlefttimeset matches 4 run tellraw @a {text:"left安装时间已设为4分钟！",color:"green"}
execute if score #toggle maxlefttimeset matches 5 run tellraw @a {text:"left安装时间已设为5分钟！",color:"green"}
execute if score #toggle maxlefttimeset matches 6 run tellraw @a {text:"left安装时间已设为6分钟！",color:"green"}