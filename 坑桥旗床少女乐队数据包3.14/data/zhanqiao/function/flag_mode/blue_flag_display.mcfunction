...
summon block_display ~ ~0.5 ~ {Tags:["blueflag_display","but","aquaglow"],block_state:{Name:"minecraft:blue_banner"},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.5f,0f],scale:[1.0f,1.0f,1.0f]},teleport_duration:1}
