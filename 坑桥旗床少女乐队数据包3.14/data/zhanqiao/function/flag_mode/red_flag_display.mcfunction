...
summon block_display ~ ~0.5 ~ {Tags:["redflag_display","but","orangeglow"],block_state:{Name:"minecraft:red_banner"},transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.5f,0f],scale:[1.0f,1.0f,1.0f]},teleport_duration:1}
