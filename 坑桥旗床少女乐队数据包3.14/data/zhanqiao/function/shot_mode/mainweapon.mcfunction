...
execute if score @s mainweapon matches 7 run give @s[nbt=!{Inventory:[{id:"minecraft:crossbow",components:{"minecraft:custom_data":{type:"manowar"}}}]}] minecraft:crossbow[item_model=blaze_powder,unbreakable={},custom_data={type:"manowar"},minecraft:enchantments={"infinity":5,quick_charge:4,flame:6,power:4},custom_name=[{"text":"Man O'War","color":"aqua"}],lore=[{text:"点击输入文本的又一力作，自带铝热弹夹"}]]
