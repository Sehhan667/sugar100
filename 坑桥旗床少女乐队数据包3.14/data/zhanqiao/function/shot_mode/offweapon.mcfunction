...
execute if score @s offweapon matches 5 run give @s[nbt=!{Inventory:[{id:"minecraft:iron_pickaxe",components:{"minecraft:custom_data":{type:"iron_pickaxe"}}}]}] iron_pickaxe[enchantments={efficiency:4},unbreakable={},custom_data={type:"iron_pickaxe"},custom_name="拆弹器",lore=[{text:"沃趣原本要花钱买的给你免费用了这还得了"}]] 1
